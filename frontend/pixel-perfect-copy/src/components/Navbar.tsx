    ...
    <nav className="absolute top-0 left-0 right-0 z-50 px-6 lg:px-16 py-5">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <div className="hidden lg:flex items-center gap-10">
          <a href="/" className="text-eco-yellow font-semibold text-sm tracking-wide">Home</a>
          <a href="/about" className="text-primary-foreground/80 hover:text-primary-foreground text-sm font-medium transition-colors">🤖 AI Chatbot</a>
          <div
          ...
          >
            <button className="flex items-center gap-1 text-primary-foreground/80 hover:text-primary-foreground text-sm font-medium transition-colors">
              Essential Pages <ChevronDown className={`w-4 h-4 transition-transform ${dropdownOpen ? "rotate-180" : ""}`} />
            </button>
            {dropdownOpen && (
          ...
          <a href="/shop" className="text-primary-foreground/80 hover:text-primary-foreground text-sm font-medium transition-colors">Shop</a>
        </div>
      ...
      {mobileOpen && (
        <div className="lg:hidden mt-4 bg-eco-green-dark/95 backdrop-blur-md rounded-2xl p-6 flex flex-col gap-4">
          <a href="/" className="text-eco-yellow font-semibold">Home</a>
          <a href="/about" className="text-primary-foreground/80">🤖 AI Chatbot</a>
          <a href="/gallery" className="text-primary-foreground/80">Gallery</a>
          <a href="/testimonial" className="text-primary-foreground/80">Testimonial</a>
          <a href="/faq" className="text-primary-foreground/80">FAQ</a>
          <a href="/shop" className="text-primary-foreground/80">Shop</a>
